...
const AchievementCard = ({ id, imgUrl, bronze, silver, gold, userId }) => {
    return (
        <div className='bg-white rounded w-full aspect-video relative hover:last:hidden'>
            <img src={imgUrl} className='object-cover h-full w-full' />

            <div className='absolute top-0 left-0 inset-0 flex flex-col' style={{ backgroundColor: 'rgb(0 0 0 / .45)' }}>
